CREATE OR REPLACE VIEW DEVV_STG_FLX.STTM_AC_LINKED_ENTITIES_get_delta AS LOCKING ROW FOR ACCESS
SELECT
  ...
  END AS OPT_FLAG
FROM DEVT_STG_FLX.STTM_AC_LINKED_ENTITIES AS X
FULL JOIN DEVT_STG_FLX.STTM_AC_LINKED_ENTITIES_BACKUP AS Y

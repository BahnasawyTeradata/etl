CREATE OR REPLACE VIEW DEVV_STG_FLX.ACTB_HISTORY_get_delta AS LOCKING ROW FOR ACCESS
SELECT
  ...
  END AS OPT_FLAG
FROM DEVT_STG_FLX.ACTB_HISTORY AS X
FULL JOIN DEVT_STG_FLX.ACTB_HISTORY_BACKUP AS Y
